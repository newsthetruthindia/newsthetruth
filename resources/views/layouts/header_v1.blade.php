...
<div class="th-menu-wrapper">
    <div class="th-menu-area text-center">
        ...
        <div class="mobile-logo">
            <a href="{{route('v1.home')}}"><img src="{{ asset('public/v1/img/image_logo.jpg') }}" alt="{{env('MAIL_FROM_NAME')}}"></a>
        </div>
                                ...
                                <div class="news-area">
                                    ...
                                    <div class="news-wrap">
                                        <div class="row slick-marquee">
                                            ...
                                            <div class="col-auto"><a href="{{ route('public.page', ['x' => $marq->slug])}}" class="breaking-news">{{ substr($marq->title,0,100); }}...</a></div>
                                            @endforeach
                    ...
                    <div class="menu-area">
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-auto d-lg-none d-block">
                                <div class="header-logo">
                                    <a href="{{route('v1.home')}}"><img class="light-img" src="{{ asset('public/v1/img/image_logo.jpg') }}" alt="{{env('MAIL_FROM_NAME')}}"></a>
                                    <a href="{{route('v1.home')}}"><img class="dark-img" src="{{ asset('public/v1/img/image_logo.jpg') }}" alt="{{env('MAIL_FROM_NAME')}}"></a>
                                </div>
                            </div>
