...
<body class="{{ (!empty($body_classes)? $body_classes: "default") }}">
    ...
    <header class="site-navbar site-navbar-target py-4 bg-white site-head" role="banner">
        <div class="container-fluid">
            <div class="row">
                <div class="col col-md-3 col-xs-3 order-xs-2">
                ...
                <div class="col col-xs-9 col-md-6 order-xs-3 text-center main-logo">
                    <strong>
                ...
                <div class="col col-xs-12 col-md-3 order-xs-1 support-button">
