                    ...
                    <div class="social-share text-center">
                        ...
                        <ul>
                            ...
                            @if( !empty( $settings['follow_twitter'] ) )
                                <li>
                                    <a href="{{ $settings['follow_twitter'] }}" target="_blank" data-toggle="tooltip" title="Linkedin">
                                        <image src="{{ asset('public/img/social/twitter-alt.png') }}"/>
                                    </a>
                                </li>
                            @endif
                            @if( !empty( $settings['follow_instagram'] ) )
                                <li>
                                    <a href="{{ $settings['follow_instagram'] }}" target="_blank" data-toggle="tooltip" title="Linkedin">
                            ...
                            @if( !empty( $settings['follow_youtube'] ) )
                                <li>
                                    <a href="{{ $settings['follow_youtube'] }}" target="_blank" data-toggle="tooltip" title="Linkedin">
                            ...
                            @if( !empty( $settings['follow_telegram'] ) )
                                <li>
                                    <a href="{{ $settings['follow_telegram'] }}" target="_blank" data-toggle="tooltip" title="Linkedin">
  ...
  var siteSticky = function() {
   ...
   $('#carosoul').owlCarousel({
    ...
    if ( ($(window).width() < 1100) && ($(window).height() > $(window).width()) ) {
        $(document).find('.support-button').find('span').each((i, e)=>{
            let html = $(e).html();
