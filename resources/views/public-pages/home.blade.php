...
@if( !empty( $just_in ) && $enable_just_in)
	<section class="home-archive latest-news xyzsk">
                    				...
                    				<div class="col-lg-12 text-center">
                    					<div class="">
                    						@if( !empty( $the_data->thumbnails->url ) )
                    							<img src="{{ url($the_data->thumbnails->url) }}" srcset="{{ get_image_srcset($the_data->thumbnails->id)}}"/>
                    						@endif
                    					</div>
                    				</div>
                				</div>
    					...
    					@if( !empty( $the_data ) )
    						<div class="row article">
    							...
    							<div class="col-md-7 title">
    								...
    								</a><span class="read-more text-danger">
        								    <?php date_default_timezone_set('Asia/Kolkata'); ?>
        									{{ date('d-m-Y h:i:s a', strtotime($the_data->updated_at.'+330 minutes') ) }}
        								</span>
    							</div>
    						</div>
    					@endif
...
@endif
@if( !empty( $others['THE TRUTH DARES'] ) && count( $others['THE TRUTH DARES'] ) > 0 )
<section class="home-archive untold-story">
	<div class="container-fluid">
		<div class="row heading">
			<div class="col-md-12">
		...
		<div class="row bg-white">
			<div class="col-lg-9 news-section">
				@foreach( $others['THE TRUTH DARES'] as $the_data)
					@if( !empty( $the_data ) )
						<div class="row article">
							<div class="col-md-4 video">
