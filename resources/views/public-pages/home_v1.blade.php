                    ...
                    <div class="row gy-4">
                        <div class="dark-theme img-overlay2">
                            <div class="blog-style3">
                                ...
                                <div class="blog-img">
                                    <img src="{{ $first->thumbnails ? url($first->thumbnails->url) : asset('public/v1/img/blog/blog_5_7.jpg') }}" alt="{{ $first->title }}">
                                </div>
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="blog-meta">
                                        <a href="javascript:void(0);"><i class="fal fa-calendar-days"></i>{{ $first->created_at->format('d M, Y') }}</a>
                                    </div>
                                </div>
							...
							<div class="row gy-4">
								...
								<div class="col-xl-12 col-md-6 border-blog">
									<div class="blog-style2 pb-2">
										<div class="blog-img"><img src="{{ $t_p->thumbnails ? url($t_p->thumbnails->url) : asset('public/v1/img/blog/blog_5_2_1.jpg') }}" alt="{{ $t_p->title }}"></div>
										<div class="blog-content"><a data-theme-color="#FF9500" href="javascript:void(0);" class="category mb-1">{{ $t_p->metas()->where('key','category')->first()->title ?? 'News' }}</a>
											<h3 class="box-title-cus"><a class="hover-line" href="{{ $link }}">{{ \Illuminate\Support\Str::limit($t_p->title, 55) }}</a></h3>
											<div class="blog-meta"><a href="javascript:void(0);"><i class="fal fa-calendar-days"></i>{{ $t_p->created_at->format('d M, Y') }}</a></div>
										</div>
									</div>
								</div>
                                @endforeach
                        ...
                        <div class="border-blog2 filter-item cat1">
                            <div class="blog-style4">
                                <div class="blog-img">
                                    ...
                                    @else
                                    <img src="{{ asset('public/img/product/bg-1.jpg') }}" alt="{{$latest->title}}" />
                                    @endif
                                </div>
                                <div class="blog-content">
                        ...
                        <div class="border-blog2 filter-item cat1">
                            <div class="blog-style4">
                                <div class="blog-img">
                                    ...
                                    @else
                                    <img src="{{ asset('public/img/product/bg-1.jpg') }}" alt="{{ $the_exclusive->title }}" />
                                    @endif
                                </div>

                                <div class="blog-content">
                                    <h3 class="box-title-24">
                                        <a href="{{ route('public.page', ['x' => $the_exclusive->slug]) }}" class="hover-line">
                                            {{ $the_exclusive->title }}
                                        </a>
                                    </h3>
                                    ...
                                    <a href="{{ route('public.page', ['x' => $the_exclusive->slug]) }}" class="th-btn style2">Read More<i class="fas fa-arrow-up-right ms-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="filter-active">
                        <div class="border-blog2 filter-item cat1">
                            <div class="blog-style4">
                                ...
                                <div class="blog-content">
                                    <h3 class="box-title-24">
                                        <a href="{{ route('public.page', ['x' => $the_untold->slug]) }}" class="hover-line">
                                            {{ $the_untold->title }}
                                        </a>
                                    </h3>
                                    ...
                                    <a href="{{ route('public.page', ['x' => $the_untold->slug]) }}" class="th-btn style2">Read More<i class="fas fa-arrow-up-right ms-2"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="border-blog2 filter-item cat1">
                            <div class="blog-style4">
                                <div class="blog-img">
                                    ...
                                    @else
                                    <img src="{{ asset('public/img/product/bg-1.jpg') }}" alt="{{ $the_data->title }}" />
                                    @endif
                                </div>

                                <div class="blog-content">
                                    <h3 class="box-title-24">
                                        <a href="{{ route('public.page', ['x' => $the_data->slug]) }}" class="hover-line">
                                            {{ $the_data->title }}
                                        </a>
                                    </h3>
                                    ...
                                    <a href="{{ route('public.page', ['x' => $the_data->slug]) }}" class="th-btn style2">Read More<i class="fas fa-arrow-up-right ms-2"></i></a>
                                </div>
                            </div>
                        </div>
                        @endif
                ...
                <div class="col-xl-3 mt-35 mt-xl-0 mb-10 sidebar-wrap sidebar-wrap-cus">
                    <div class="sidebar-area">
                        <div class="nav tab-menu indicator-active" role="tablist">
                            ...
                            <button class="tab-btn active" id="nav3-one-tab" data-bs-toggle="tab" data-bs-target="#nav3-one" type="button" role="tab" aria-controls="nav3-one" aria-selected="true">Politics</button>
                            @endif
                            @if( !empty( $others['WORLD'] ) && count( $others['WORLD'] ) > 0 )
                            <button class="tab-btn" id="nav3-two-tab" data-bs-toggle="tab" data-bs-target="#nav3-two" type="button" role="tab" aria-controls="nav3-two" aria-selected="false">World</button>
                            @endif
                        </div>
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="nav3-one" role="tabpanel" aria-labelledby="nav3-one-tab">
                                <div class="row gy-4">
                                    ...
                                    <div class="blog-content">
                                        <h3 class="box-title-18 box-title-c"><a class="hover-line" href="{{ route('public.page', ['x' => $the_data->slug]) }}">{{ \Illuminate\Support\Str::limit($the_data->title, 65) }}</a></h3>
                                        <div class="blog-meta"><a href="javascript:void(0);"><i class="fal fa-calendar-days"></i>{{ $the_data->updated_at->format('d M, Y') }}</a></div>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
