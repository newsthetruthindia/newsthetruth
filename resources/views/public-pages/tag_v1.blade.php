                        ...
                        <div class="border-blog2 filter-item cat1">
                            <div class="blog-style4">
                                ...
                                <div class="blog-content">
                                    <h3 class="box-title-24"><a class="hover-line" href="{{ url($item->slug) }}">{{ substr($item->title,0,100); }}...</a></h3>
                ...
                <div class="col-xl-3 mt-35 mt-xl-0 mb-10 sidebar-wrap">
                    <div class="sidebar-area">
                        <div class="widget widget_tag_cloud">
                            <h3 class="widget_title">Other Tags</h3>
                            <div class="tagcloud">
                                @foreach( $tags as $tag )
                                    @if( !empty( $tag ) )
                                        <a href="{{ url( $tag->slug ) }}">{{ $tag->title }}</a>
                                    @endif
                                @endforeach
                            </div>
                        </div>
