<x-filament-panels::page>
    <div wire:init="loadData" class="monitor-system-root fixed inset-0 z-[100] bg-black overflow-hidden flex flex-col">
        ...
        <div class="absolute top-6 right-6 z-[200] opacity-10 hover:opacity-100 transition-opacity flex items-center gap-3">
            ...
            <button wire:click="mountAction('configure')" class="px-4 py-2 bg-neutral-900 text-neutral-400 text-[10px] font-mono uppercase tracking-widest hover:text-white border border-neutral-800 transition-colors">
                Configure Monitor
            </button>
        </div>
